...
window.fscreen = Object.freeze({
  ...
  get isFullscreen() {//https://blog.tsukumijima.net/article/javascript-fullscreen-decision/
  ...
  //toggle() {this.isFullscreen ? this.exitFullscreen() : this.requestFullscreen()},
  toggle(el) {
      console.log(this);
      this.isFullscreen ? this.exitFullscreen() : this.requestFullscreen(el ?? this.fullscreenElement ?? document.documentElement);
  },
});
})();
