...
//        van.tags.p('A UI that extends textarea to enable indentation.'),
        van.tags.p('　textareaはReadOnly/Enabledモードがある。Tab, Shift+Tabの挙動がフォーカスかインデントかの違いがある。モード切替は、ReadOnly時はTab,Shift,Ctrl,Alt,Space,BkSp以外のキー、Enabled時はEscキーを押下すると切り替わる。'),
    );
