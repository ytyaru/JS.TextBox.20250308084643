...
`);
    ...
    #makeEl() {
        ...
        */
        ...
        //this._shadow.append(textarea, overlayMenu.el);
        console.log(overlayMenu.help)
        overlayMenu.help.addEventListener('click', ()=>{
//            const el = document.querySelector(`div[name="help"]`);
//            el.style.display = 'none'===el.style.display ? 'block' : 'none';
            const style = document.querySelector(`div[name="help"]`).style;
            style.display = 'none'===style.display ? 'block' : 'none';
        });
        this._shadow.append(textarea, overlayMenu.style, overlayMenu.helpDiv, overlayMenu.fileStateDiv, overlayMenu.buttonsDiv);
    }
    /*
    #makeUi() {
